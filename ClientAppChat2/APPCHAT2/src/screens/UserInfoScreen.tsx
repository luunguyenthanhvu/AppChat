...
import { BACKEND_URL_HTTP } from "../config/config"; // Thêm URL từ config
...
const UserInfoScreen = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchUserInfo = async () => {
            try {
                const response = await fetch(`http://${BACKEND_URL_HTTP}/api/user/${user.id}`); // Lấy dữ liệu người dùng từ API
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.actionSection}>
                ...
                <TouchableOpacity style={styles.actionItem}>
                    ...
                    <Text>Xem tin nhắn đã ghim</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionItem}>
                ...
                <TouchableOpacity style={styles.actionItem}>
                    ...
                    <Text>Xác minh mã hóa đầu cuối</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionItem}>
                    <MaterialIcons name="timer" size={24} color="black" />
                    <Text>Tin nhắn tự hủy</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionItem}>
