    ...
    return (
        <Tab.Navigator
            screenOptions={({ route }) => ({
                ...
                tabBarShowLabel: true,  // Hiển thị tên của tab
            })}
        >
            <Tab.Screen
                name="ChatList"
                ...
                options={{
                    tabBarLabel: 'Chats',
                    headerTitle: 'Danh sách trò chuyện',  // Tiêu đề cho màn hình ChatList
                }}
            />
            <Tab.Screen
                name="AddFriend"
                ...
                options={{
                    tabBarLabel: 'Thêm bạn bè',
                    headerTitle: 'Thêm bạn bè',  // Tiêu đề cho màn hình AddFriend
                }}
            />
        </Tab.Navigator>
    );
